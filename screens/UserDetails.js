...
constructor(props){
  ...
  this.state={
    ...
    requestId       : this.props.navigation.getParam('details')["exchnage_id"],
...
getRecieverDetails(){
  ...
  /*db.collection('exchanges').where('exchnage_id','==',this.state.requestId).get()
  .then(snapshot=>{
    snapshot.forEach(doc => {
...
updateStatus=()=>{
  db.collection('MyBartars').add({
    ...
    "exchnage_id"          : this.state.requestId,
...
addNotification=()=>{
  var message = this.state.userName + " has shown interest in your item"
            ...
            ?(
              <TouchableOpacity
                  ...
                  onPress={()=>{
                    ...
                    this.props.navigation.navigate('MyBartars')
                  }}>
